                                    ...
                                    <div class="col-md-6 my-2">
                                        <div class="mb-3">
                                            <label for="firstNameinput" class="form-label">Type</label>
                                                <select name="fields_type" id="" class="form-control">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 my-2">
                                        <div class="mb-3">
                                            <label for="firstNameinput" class="form-label">Type</label>
                                                <select name="fields_type" id="type" class="form-control">
                                                    @foreach ($types as $type)
                                                    <option value="{{$type['id']}}">{{$type['title']}}</option>
                                                    @endforeach
                                                </select>
    ...
    var table = $('#alternative-pagination').DataTable({
            ...
            columns: [
...

                {
                    'data': null,
                    render: function(data) {
                        var editButton = '<button   data-bs-toggle="modal" data-bs-target="#update" class="btn btn-warning edit-btn" data-id="' + data.id + '" data-title_ar="' + data.title_ar  + '" data-title_en="' + data.title_en + '" data-type="' + data.type.id + '"><i class="bx bxs-edit"></i></button>';
