...
var table = $('#alternative-pagination').DataTable({
    ...
    columns: [
...

        {
                    'data': null,
                    render: function(data) {
                        var verificationsTemplete = '{{ route('customer.verifications', ':customer') }}';

                        var verifications = verificationsTemplete.replace(':customer', data.id);


                        var verificationsButton = '<a href="' + verifications + '" title="Fields"> <i class="bx bxs-data btn btn-primary"></i></a>';

                        return      verificationsButton   ;
